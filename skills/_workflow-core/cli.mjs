...
// THIS FILE'S OWN LOCATION, handed to a core that has to find something shipped at a fixed offset from it. The cores
// may not use `import.meta` themselves: the generator inlines them into a workflow script the host evaluates as a
// function body, where it is a parse error. So the adapter is where it lives.
