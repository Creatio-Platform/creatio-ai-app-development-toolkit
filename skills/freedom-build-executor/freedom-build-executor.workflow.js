...
function downgradeSurface(requested, { renderReachable } = {}) {
...
function standFingerprint({ planVersion = null, standWrites = null } = {}) {
...
function canReuseReconcile({ persistedVerdict, prevFingerprint, curFingerprint } = {}) {
...
function progressed(prevOpen, curOpen) {
...
function openDeliverableCount(verify) {
