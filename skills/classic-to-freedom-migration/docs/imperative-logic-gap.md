...
| `getSectionActions` | one item per menu entry — `{ name, caption, condition, icon, parent, order, group, package }`, helper-built items included (one hop) | `engine.mjs:892-1087` |
