...
- For state-dependent workflow actions, remove actions that do not apply in the current state, for example hide “Send for approval” once the record is already under approval.
