		...
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					...
					"visible": true,
					"layoutConfig": { "column": 1, "row": 6, "colSpan": 1, "rowSpan": 1 }
				},
				"parentName": "SideAreaProfileContainer",
				"propertyName": "items",
				"index": 5
			...
			},
			{
				...
				"name": "GeneralInfoTab",
				"values": {
					"caption": "#ResourceString(ScheduleTabCaption)#"
				}
			},
			{
				"operation": "insert",
				...
				"values": {
					...
					"items": [],
					"tools": [],
					"layoutConfig": { "column": 1, "row": 1, "colSpan": 24, "rowSpan": 8 }
				},
			...
			},
			{
				...
				"parentName": "ScheduleToolsContainer",
				"propertyName": "items",
				"index": 0
			},
			{
				...
				"values": {
					...
					"clicked": {
						...
						"params": {
							"entityName": "SupportSchedule",
							"entityPageName": "UsrSchedulePoC_FormPage",
							"defaultValues": [
								{ "attributeName": "SupportUnit", "value": "$Id" }
							]
						}
					}
				},
				"parentName": "ScheduleToolsRow",
				"propertyName": "items",
				"index": 0
			}
