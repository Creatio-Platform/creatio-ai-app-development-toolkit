...
// the first is a measured defect: the wiring card said a lead "may" be created, while the criteria that gate it
// (first save and only then · never when one already exists) were in the body card, and the build shipped neither.
...
// aggregated key hides many bodies. The measured defect this floors is the one pinned in the TWO-cards block above.
