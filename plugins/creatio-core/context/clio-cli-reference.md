...
Resolve a writable package before schema edits (see `plugins/creatio-app-builder/skills/creatio-app-orchestrator/references/01-environment-setup.md`, step 8). Installed-app packages are often locked / read-only and reject direct schema writes mid-run.
